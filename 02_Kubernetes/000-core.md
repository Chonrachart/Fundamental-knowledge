...
2. Common causes: no nodes match scheduling constraints, insufficient resources, PVC not bound.
...
3. Common causes: app crash, missing env/config, liveness probe too aggressive.

### Service not reachable
1. Check endpoints: `kubectl get endpoints <svc>` — must have pod IPs.
2. Check selector matches pod labels: `kubectl get pods -l <selector>`.
3. Check pod is Running and Ready.
